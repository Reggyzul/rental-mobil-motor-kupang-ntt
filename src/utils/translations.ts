...
export const TRANSLATIONS: Record<'EN' | 'ID', TranslationSchema> = {
  ID: {
    ...
    brand_tagline_alt: "Rental Mobil & Travel Antar Kota Medan - Sumatera (PP)",
    topbar_address: "📍 Simalingkar B, Medan, Sumatera Utara",
    topbar_whatsapp: "📱 WA: 0852-7060-7796 | 📞 Telp: 0812-6232-0086",
    topbar_tiktok: "🎵 TikTok: @hendry.manullang",
    topbar_service: "Jasa Transportasi, Rental Mobil & Wisata (PP)",

    // Hero Section
    hero_title: "CV SRM MANDIRI",
    hero_tagline: "“Melayani Jasa Transportasi Terpercaya di Medan & Antar Kota Sumatera (PP)”",
    hero_description: "CV SRM MANDIRI melayani jasa transportasi profesional dengan armada pilihan: Innova, Avanza, Sigra, dan Calya. Melayani rute Pulang-Pergi (PP) Medan, Dumai, Duri, Kandis, Garut, Pekanbaru, Kerinci, Jambi, serta paket wisata favorit Berastagi, Parapat, dan Pulau Samosir (PP).",
    hero_cta_wa: "Hubungi WhatsApp Admin",
    hero_cta_vehicles: "Pilihan Armada & Rute (PP)",
    ...
    mission_3: "Melayani rute Pulang-Pergi (PP) antar kota dan provinsi (Medan, Dumai, Duri, Kandis, Garut, Pekanbaru, Kerinci, Jambi) secara tepat waktu.",
    mission_4: "Menyediakan layanan tour wisata terbaik (PP) ke Berastagi, Parapat, Pulau Samosir, dan Danau Toba.",
    mission_5: "Memberikan tarif sewa yang kompetitif, transparan, dan terjangkau untuk seluruh lapisan masyarakat.",
    mission_6: "Memberikan pelayanan yang ramah, sopan, responsif, dan siap melayani konsultasi via WhatsApp & Telepon.",

    // Services Section
    services_tag: "LAYANAN UTAMA",
    services_title: "Layanan Jasa Transportasi CV SRM MANDIRI",
    services_desc: "Kami melayani berbagai kebutuhan transportasi darat mulai dari rental mobil harian, carter travel antar kota (PP), hingga paket wisata keluarga dan rombongan (PP).",
    ...
    service_2_title: "Travel & Carter Antar Kota (PP)",
    service_2_desc: "Layanan carter dan travel Pulang-Pergi (PP) rute Medan, Dumai, Duri, Kandis, Garut, Pekanbaru, Kerinci, Jambi dengan perjalanan yang aman dan nyaman.",
    service_3_title: "Paket Wisata Sumatera Utara (PP)",
    service_3_desc: "Paket liburan dan tour keluarga Pulang-Pergi (PP) ke destinasi ikonik Berastagi, Danau Toba Parapat, dan Pulau Samosir.",
    service_4_title: "Antar-Jemput Bandara & Stasiun (PP)",
    ...
    routes_desc: "Melayani perjalanan antar kota dan antar provinsi Pulang-Pergi (PP) se-Sumatera dengan driver berpengalaman, nyaman dan selamat sampai tujuan.",
    routes_btn_wa: "Pesan Tiket / Carter Rute Ini (PP)",

    // Tours / Destinations Section
    tours_tag: "DESTINASI WISATA FAVORIT",
    tours_title: "Destinasi Wisata Favorit",
    tours_desc: "Nikmati keindahan alam Sumatera Utara bersama CV SRM MANDIRI dengan pengalaman perjalanan Pulang-Pergi (PP) yang menyenangkan dan tak terlupakan.",
    ...
    vehicles_price_note: "Catatan: Tarif rental dan carter dapat disesuaikan dengan rute tujuan Pulang-Pergi (Medan, Dumai, Duri, Kandis, Garut, Pekanbaru, Kerinci, Jambi PP), durasi sewa, serta kebutuhan include driver/BBM. Hubungi WhatsApp Admin untuk penawaran terbaik.",
    ...
    why_2_title: "Rute Luas Lintas Sumatera (PP)",
    why_2_desc: "Melayani rute Pulang-Pergi (PP) Medan, Dumai, Duri, Kandis, Garut, Pekanbaru, Kerinci, Jambi dan kota-kota sekitarnya.",
    why_3_title: "Spesialis Wisata Berastagi & Samosir (PP)",
    why_3_desc: "Driver kami sangat hafal rute wisata Pulang-Pergi Berastagi, Parapat Danau Toba, dan Pulau Samosir.",
    why_4_title: "Harga Bersahabat & Transparan",
    why_4_desc: "Tarif sewa mobil dan carter sangat kompetitif tanpa biaya tersembunyi.",
    why_5_title: "Respon Cepat & Siap Melayani",
    why_5_desc: "Admin responsif siap melayani konsultasi via WhatsApp (0852-7060-7796) dan Telepon (0812-6232-0086).",
  ...
  EN: {
    ...
    brand_tagline_alt: "Car Rental & Intercity Travel Medan - Sumatra (PP)",
    topbar_address: "📍 Simalingkar B, Medan, North Sumatra",
    topbar_whatsapp: "📱 WA: 0852-7060-7796 | 📞 Phone: 0812-6232-0086",
    topbar_tiktok: "🎵 TikTok: @hendry.manullang",
    topbar_service: "Transportation, Car Rental & Tour Services (PP)",

    // Hero Section
    hero_title: "CV SRM MANDIRI",
    hero_tagline: "“Serving Reliable Transportation in Medan & Across Sumatra (PP)”",
    hero_description: "CV SRM MANDIRI provides professional transportation services with choice fleets: Innova, Avanza, Sigra, and Calya. Serving round-trip (PP) routes Medan, Dumai, Duri, Kandis, Garut, Pekanbaru, Kerinci, Jambi, and favorite tour packages to Berastagi, Parapat, and Samosir Island (PP).",
    hero_cta_wa: "Contact Admin on WhatsApp",
    hero_cta_vehicles: "Explore Fleet & Routes (PP)",
    ...
    mission_3: "Serve round-trip (PP) intercity and interstate travel routes (Medan, Dumai, Duri, Kandis, Garut, Pekanbaru, Kerinci, Jambi) punctually.",
    mission_4: "Provide top-notch vacation and sightseeing trips (PP) to Berastagi, Parapat, Samosir Island, and Lake Toba.",
    mission_5: "Offer competitive, transparent, and affordable rental rates for all customers.",
    mission_6: "Ensure friendly, respectful, and responsive service available via WhatsApp & Phone.",

    // Services Section
    services_tag: "OUR SERVICES",
    services_title: "CV SRM MANDIRI Transportation Services",
    services_desc: "We serve a wide spectrum of ground transportation needs, ranging from daily car rentals to round-trip (PP) intercity charters and family tour packages.",
    ...
    service_2_title: "Intercity Travel & Charter (PP)",
    service_2_desc: "Round-trip (PP) charter and travel services across Medan, Dumai, Duri, Kandis, Garut, Pekanbaru, Kerinci, and Jambi with utmost safety.",
    service_3_title: "North Sumatra Tour Packages (PP)",
    service_3_desc: "Exciting round-trip (PP) holiday tours to iconic North Sumatra gems: Berastagi highlands, Lake Toba Parapat, and Samosir Island.",
    service_4_title: "Airport & Station Transfers (PP)",
    ...
    routes_desc: "Serving round-trip (PP) intercity and interstate journeys across Sumatra with professional drivers, ensuring comfort and peace of mind.",
    routes_btn_wa: "Book / Charter This Route (PP)",

    // Tours / Destinations Section
    tours_tag: "POPULAR TOURIST SPOTS",
    tours_title: "Popular Tourist Destinations",
    tours_desc: "Experience the mesmerizing landscapes of North Sumatra with CV SRM MANDIRI for a truly memorable round-trip (PP) journey.",
    ...
    vehicles_price_note: "Note: Rental and charter rates can be customized based on destination (Medan, Dumai, Duri, Kandis, Garut, Pekanbaru, Kerinci, Jambi PP), duration, and driver/fuel inclusions. Contact WhatsApp Admin for best quotes.",
    ...
    why_2_title: "Extensive Sumatra Routes (PP)",
    why_2_desc: "Serving round-trip (PP) routes across Medan, Dumai, Duri, Kandis, Garut, Pekanbaru, Kerinci, Jambi and surrounding regions.",
    why_3_title: "Berastagi & Samosir Tour Specialist (PP)",
    ...
    why_5_title: "Fast Response & Ready to Serve",
    why_5_desc: "Responsive service ready to assist via WhatsApp (0852-7060-7796) and Phone (0812-6232-0086).",
    ...
    step_1_desc: "Click the WhatsApp button on our site (0852-7060-7796) or call (0812-6232-0086) to connect with CV SRM MANDIRI admin.",
    ...
    step_3_desc: "Share your schedule and travel route (Medan, Dumai, Duri, Kandis, Garut, Pekanbaru, Kerinci, Jambi PP, or Tour Berastagi/Parapat/Samosir PP).",
    ...
    modal_field_notes: "Destination Route / Extra Notes (PP)",
    modal_field_wa_target: "Official WhatsApp Contact:",
    modal_btn_submit: "Send Reservation to WhatsApp ➔",

    // Footer & Contact
    footer_cta_heading: "Need Reliable Transportation in Medan & Intercity?",
    footer_cta_sub: "Contact CV SRM MANDIRI now! We are ready to serve your car rental, intercity charter (PP), and tour travels safely and comfortably.",
    footer_cta_btn: "Chat WhatsApp: 0852-7060-7796",
    footer_address_title: "Office Address:",
    footer_address_text: "Simalingkar B, Medan, North Sumatra",
    footer_wa_title: "Official Contacts:",
    footer_wa_text: "WA: 0852-7060-7796 | Telp: 0812-6232-0086",
