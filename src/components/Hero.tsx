...
export default function Hero({ onExploreClick, lang }: HeroProps) {
  ...
  return (
    <section id="home" className="relative pt-24 sm:pt-28 bg-slate-50 text-slate-900 overflow-hidden text-left">
      
      {/* 1. PANORAMIC HERO PHOTO BANNER (Matching reference screenshot top banner) */}
      <div className="relative w-full h-[320px] sm:h-[400px] bg-[#061226] text-white overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[#061226]/80 via-[#061226]/50 to-[#061226]/90" />

        {/* Subtle Location Pill in Banner */}
        <div className="relative z-10 max-w-7xl mx-auto px-4 pt-8 flex items-center justify-between">
      ...
      {/* 2. OVERLAPPING WHITE CONTENT CARD (Exact match to reference screenshot) */}
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-20 -mt-24 sm:-mt-28 mb-4">
        <motion.div
        ...
        >
          ...
          {/* Breadcrumb Navigation Line (like "Malioboro Tour > Sewa Mobil Jogja") */}
          ...
          {/* Minimalist Subtext (concise, simple, preserves original meaning) */}
